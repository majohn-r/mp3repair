...
func TestTrackMetadataMaker_Make(t *testing.T) {
	...
	for _, src := range sourceTypes {
		...
		tm.setAlbumYear(src, "album year")
		tm.setTrackName(src, "track name")
		tm.setTrackNumber(src, 1)
	}
	tm.setCDIdentifier([]byte{1, 2, 3, 4})
